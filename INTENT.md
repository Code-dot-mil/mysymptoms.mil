...
The intent is that MySymptoms.mil should be treated as if it is licensed under the license associated in the LICENSE.md file. However, because we are part of the United States (U.S.) Federal Government, it is not that simple.
